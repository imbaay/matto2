...
<head>
    ...
    <title>@yield('title', 'Phoneshop - Home')</title>
    <!-- Favicon icon -->
...
<section class="header py-2 bg-light">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="{{route('all-phones')}}">
                    <div class="input-group input-group-sm m-1">
                        <input type="text" name="term" value="{{request('term')}}" class="form-control" placeholder="Search Phone..">
