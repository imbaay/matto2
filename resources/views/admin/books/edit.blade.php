            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="display-img text-center p-4">
                        <img src="{{$phone->image? $phone->image_url:$phone->default_img}}" alt="">
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="card-body">
                        {!! Form::model($phone, ['method'=>'PATCH', 'action'=>['Admin\AdminPhonesController@update', $phone->id], 'files'=>true]) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('nation_id', App\Nation::pluck('name', 'id'), null,['placeholder'=>'Select nation','class'=>'form-control '.($errors->has('nation_id')? 'is-invalid': '')]) !!}
