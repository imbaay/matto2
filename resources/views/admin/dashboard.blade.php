...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$total_earning}} TK</div>
                            </div>
                            <div class="col-auto">
            ...
            <!-- Quantity of all phones Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$phones_quantity}}</div>
                            </div>
                            <div class="col-auto">
